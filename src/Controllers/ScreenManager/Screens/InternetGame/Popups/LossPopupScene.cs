...
public class LossPopupScene : IScene 
{
    private InternetGameScreen _internetGameScreen;
    private PackedScene _packedScene;
    private LosePopup _node;
    
    public const string ResourcePath = ResourcePaths.LoseOverlayNodePath;
    
    public LossPopupScene(InternetGameScreen internetGameScreen) 
    {
    ...
    public override Control Initialize()
    {
        ...
        _node = _packedScene.Instantiate() as LosePopup;
        _node.OnQuitPressed += () =>
        {
