...
public class WaitingPopupScene : IScene 
{
    private InternetGameScreen _internetGameScreen;
    private PackedScene _packedScene;
    private Waiting _waitingPopup;
    
    public const string ResourcePath = ResourcePaths.WaitingOverlayNodePath;
    
    public WaitingPopupScene(InternetGameScreen internetGameScreen) 
    {
    ...
    public override Control Initialize()
    {
        ...
        _waitingPopup = _packedScene.Instantiate() as Waiting;

        return _waitingPopup;
    }
