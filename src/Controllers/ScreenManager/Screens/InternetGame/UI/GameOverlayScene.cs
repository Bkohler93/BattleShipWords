...
public class GameOverlayScene : IScene 
{
    private InternetGameScreen _internetGameScreen;
    private PackedScene _packedScene;
    private GameOverlay _gameOverlay;
    
    public const string ResourcePath = ResourcePaths.GameOverlayNodePath;
    
    public GameOverlayScene(InternetGameScreen internetGameScreen) 
    {
    ...
    public override Control Initialize()
    {
        ...
        _gameOverlay = _packedScene.Instantiate() as GameOverlay;
        _gameOverlay.OnPauseButtonPressed += () =>
        {
            _internetGameScreen.ShowPauseMenu();
        };
